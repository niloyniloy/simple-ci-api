...
<!-- MetisMenu CSS -->
<link
	href="<?php echo $data ['base_url']; ?>dashboardmedia/css/plugins/metisMenu/metisMenu.min.css"
	rel="stylesheet">

<!-- DataTables CSS -->
<link
	href="<?php echo $data ['base_url']; ?>dashboardmedia/css/plugins/dataTables.bootstrap.css"
	rel="stylesheet">

<!-- Custom CSS -->
<link
	href="<?php echo $data ['base_url']; ?>dashboardmedia/css/sb-admin-2.css"
	rel="stylesheet">

<!-- Custom Fonts -->
<link
	href="<?php echo $data ['base_url']; ?>dashboardmedia/font-aweosome-4.1.0/css/font-awesome.min.css"
	rel="stylesheet" type="text/css">

<link rel="stylesheet"
	href="<?php echo $data ['base_url']; ?>dashboardmedia/css/typeahead.css">
<link rel="stylesheet"
...
<script
	src="<?php echo $data ['base_url']; ?>dashboardmedia/js/plugins/metisMenu/metisMenu.min.js"
	type="text/javascript"></script>

<!-- Custom Theme JavaScript -->
<script
	src="<?php echo $data ['base_url']; ?>dashboardmedia/js/sb-admin-2.js"
	type="text/javascript"></script>

<script
	src="<?php echo $data ['base_url'];?>dashboardmedia/js/typeahead.bundle.min.js"
	type="text/javascript"></script>
<script src="//code.jquery.com/ui/1.11.1/jquery-ui.js"
	type="text/javascript"></script>
<!-- Common CSS -->
<link
	href="<?php echo $data ['base_url']; ?>dashboardmedia/css/common.css"
	rel="stylesheet">
<?php
if (dashboard_view_exists ( 'core_override/dashboard_metaitems' )) {
	...
	$this->load->view ( 'core/dashboard_metaitems', $data );
}
?>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
                ...
                <div>
					<?php
                        if (dashboard_view_exists ( 'core_override/dashboard_header' )) {
                            ...
                            $this->load->view ( 'core/dashboard_header', $data );
                        }
                    ?>
                </div>
			...
			<ul class="nav navbar-top-links navbar-right">
				...
				if (dashboard_view_exists ( 'core_override/dashboard_topright' )) {
					...
					$this->load->view ( 'core/dashboard_topright', $data );
				}
				?>
			</ul>
			<!-- /.navbar-top-links -->
			...
			<div class="navbar-default sidebar" role="navigation">
				...
				if (dashboard_view_exists ( 'core_override/dashboard_leftmenu' )) {
					...
					$this->load->view ( 'core/dashboard_leftmenu', $data );
				}
				?>
			</div>
		</nav>
		...
		<div id="page-wrapper">			
			...
			<div class="row message_div ">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<p class="alert <?php echo $className; ?>"><?php echo $this->session->flashdata('flash_message'); ?></p>
				</div>
			</div>
			<!-- End Heading -->
			<?php endif;?>		
			...
			if (dashboard_view_exists ( 'core_override/dashboard_maincontent' )) {
				...
				$this->load->view ( 'core/dashboard_maincontent', $data );
			}
			?>			
		</div>
