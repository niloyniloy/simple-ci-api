...
?>
<link href="<?php echo $base_url; ?>dashboardmedia/css/select2.css" rel="stylesheet">
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.1/themes/smoothness/jquery-ui.css">
<link href="<?php echo $base_url; ?>dashboardmedia/css/edit.css" rel="stylesheet">
...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-right">
		...
		<a href="<?php  echo $base_url . $controller_sub_folder.'/'.$listing_path; ?>" class="btn btn-primary">
				...
				<div class="row">
					...
					<!-- 
						<form role="form" method="post" action="" enctype="multipart/form-data">							
							...
							$this->template->CI->get_category_role_section(@$id);
							
							
							
							if(isset($view_additional) && $view_additional){?>
							<div class="row">
								<div class="col-lg-6">
								<?php 
...
jQuery(document).ready(function(){
    ...
    var id = $("#online_payment").text();
    if ( id.length > '0' ) {

         var payment_value = $("#online_payment").val();
      if ( payment_value == '' ) {
      
           $("#online_payment").val('0').trigger('change');
      }
    }
});
</script>
